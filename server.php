...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($schoolname)) { array_push($errors, "School Name is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO accounts (username, schoolname, email, password) 
  			  VALUES('$username', '$schoolname', '$email', '$password')";
